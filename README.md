...
[![CocoaPods Compatible](https://img.shields.io/cocoapods/v/ZJWavesView.svg)](https://img.shields.io/cocoapods/v/ZJWavesView.svg)
...
## Manually【手动导入】
- Drag all source files under floder `ZJWavesView` to your project.【将`ZJWavesView`文件夹中的所有源代码拽入项目中】
- Import the main header file：`#import "ZJWavesView.h"`【导入主头文件：`#import "ZJWavesView.h"`】
...
* 如果你想为ZJWavesView输出代码，请拼命Pull Requests我。
